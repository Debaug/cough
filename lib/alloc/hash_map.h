...
#define new_hash_map(KEY, VALUE) HASH_MAP_NAME(new_hash_map, KEY, VALUE)
#define free_hash_map(KEY, VALUE) HASH_MAP_NAME(free_hash_map, KEY, VALUE)
...
#define DECL_HASH_MAP(KEY, VALUE)                                               \
    ...
    typedef struct HashMapEntry(KEY, VALUE) {                                   \
        ...
        u64 key_hash;                                                           \
                                                                                ...
                                                                                \
    HashMap(KEY, VALUE)                                                         \
    new_hash_map(KEY, VALUE)(void);                                             \
                                                                                \
    void                                                                        \
    free_hash_map(KEY, VALUE)(                                                  \
        HashMap(KEY, VALUE) hash_map                                            \
    );                                                                          \
                                                                                \
    const VALUE*                                                                \
        ...
        for (usize i = 0; i < entry->hash_map->capacity; i++) {                 \
            ...
            hash_map_insert_in_empty_slot##KEY##_##VALUE(                       \
                ...
                value                                                           \
                                                                                ...
                                                                                \
        /* replace hash map. */                                                 \
        free_hash_map(KEY, VALUE)(*entry->hash_map);                            \
